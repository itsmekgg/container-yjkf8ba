...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-yjkf8ba.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-yjkf8ba.containers.anotherwebservice.com/
...
```
git clone git@github.com:itsmekgg/container-yjkf8ba.git
cd container-yjkf8ba
```
...
```
docker attach container-yjkf8ba
```
